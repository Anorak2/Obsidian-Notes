...
# $0*\infty$
this can easily be converted to 0/0 or $\infty/\infty$ form. There are actually two ways to do this, because $1/\infty$ is 0 we can make one of the two functions  $\frac{g(x)}{1/f(x)}$ to make it zero over zero, we can also do the inverse to make it infinity over infinity.
