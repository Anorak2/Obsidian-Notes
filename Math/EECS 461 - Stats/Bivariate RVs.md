...
We will basically always use the PDF since it is much easier to work with

**JOINT PDF**
$$P_{G,h}(g,h) = P[G = g, H= h]$$

**JOINT CDF**
$$F_{G,H} (g,h) = P[G \leq g, H \leq h]$$
where ${G \leq g, H \leq h}$ is an event in a portion of the G,H plane
