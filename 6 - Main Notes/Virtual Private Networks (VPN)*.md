...
A virtual private private network is a way to tunnel your traffic to a different network so that it is as if your network traffic originated there. This solves two fundamental problems; how to protect network traffic when the user is on an insecure LAN, and how does an organization connect sites that are geographically separated? A VPN solves this by providing secure access to private network over public links with Confidentiality,  Integrity,  Mutual authentication.
## Types of VPNs
