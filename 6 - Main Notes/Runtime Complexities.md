...
| [[Hash Tables - Hashmaps\|RSC Hash Table]]                   | Hashable    | $O(1)^*$    | $O(1)^*$    |
...
| -------------- | ------------------------------------------------------------------ | ------------------ | --------------------------------- |
| Shortest Paths | [[Dijkstra's Algorithm\|Dijkstra's]]          | O(E log V)         | Fails for negative weighted edges |
| MST            | [[Graphs Spanning Tree and Min Spanning Tree\|Prim's]]             | O(E log V)         | Analogous to Dijkstra's           |
| MST            | [[Kruskal's Algorithm*\|Kruskal's]]                        | O(E log E)         | Uses WQUPC*                       |
| MST            | [[Kruskal's Algorithm*\|Kruskal's]], with pre-sorted edges |                    | Uses WQUPC*                       |
