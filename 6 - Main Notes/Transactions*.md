...
A transaction is just an executing program that forms the unit for database processing. These can be read only or write only transactions, they can also request [[Database Locking*|locks]] to prevent anomalies.
